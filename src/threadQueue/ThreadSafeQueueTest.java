...
public class ThreadSafeQueueTest {
	public static void main(String[] args) throws InterruptedException {
		...
		Counter producedMessageCounter = new Counter();
		Counter consumedMessageCounter = new Counter();
		...
		System.out.println();
		System.out.println("[RESULT] producedMessageCount : " + producedMessageCounter.getCount()
			+ ", consumedMessageCount : " + consumedMessageCounter.getCount());
	}
}